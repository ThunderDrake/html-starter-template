...
> За основу была взята [gulp-сборка Максима MaxGraph](https://github.com/maxdenaro/gulp-maxgraph)<br>Доработана под мои внутренние задачи и дорабатывается до сих пор
